...
if (pages < 1000){
    ...
    console.log(" i could read in a day and a half")
}
...
var books = ['Eldest Daugter','Lilac','King Maker','The Director','love Me']
...
var belowTwoHundred = [199,45,57,167,77,83,23,65,24,77,67,111]
